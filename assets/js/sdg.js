...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, decimalSeparator) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"geojson_file":"https://github.com/ODSValencia/data/Distritos.geojson","name_property":"nombre","id_property":"coddistrit","output_subfolder":"Distritos","filename_prefix":"indicator_"}],
      precision: precision,
